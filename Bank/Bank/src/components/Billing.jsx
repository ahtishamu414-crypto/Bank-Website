...
const Billing = () => {
  return (
    ...
    <p className={`${styles.paragraph} max-w-470px mt-5 text-white`}> Elit enim sed massa etiam. Mauris eu adipiscing ultrices ametodio aenean neque. Fusce ipsum orci rhoncus aliporttitor integer platea placerat.</p>
